...
'1.6.6': {
    ...
    'network': {
        ...
        'endpoint': '/rest/mbdetnrs/1.0/managers/1/actions/restoreSettings',
        'columns': {
            'Hostname':'features.network.data.dmeData.domain.settings.hostname',
            'DnsAlternateServer':'features.network.data.dmeData.domain.settings.manual.dns.alternateServer',
            'DnsPreferredServer':'features.network.data.dmeData.domain.settings.manual.dns.preferredServer',
            'DomainName':'features.network.data.dmeData.domain.settings.manual.domainName',
            'DomainMode':'features.network.data.dmeData.domain.settings.mode',
            'DhcpEnabled':'features.network.data.dmeData.ipv4.settings.dhcpEnabled',
            'Ipv4Enabled':'features.network.data.dmeData.ipv4.settings.enabled',
            'Ipv4Address':'features.network.data.dmeData.ipv4.settings.manual.address',
            'Ipv4Gateway':'features.network.data.dmeData.ipv4.settings.manual.gateway',
            'subnetMask':'features.network.data.dmeData.ipv4.settings.manual.subnetMask',
            'Ipv6Address':'features.network.data.dmeData.ipv6.settings.addressing.manual.address',
            'Ipv6Gateway':'features.network.data.dmeData.ipv6.settings.addressing.manual.gateway',
            'Ipv6PrefixLength':'features.network.data.dmeData.ipv6.settings.addressing.manual.prefixLength',
            'Ipv6AddressingMode':'features.network.data.dmeData.ipv6.settings.addressing.mode',
            'Ipv6Enabled':'features.network.data.dmeData.ipv6.settings.enabled',
            'LinkConfig':'features.network.data.dmeData.link.config',
            'Version':'features.network.data.version'
        }
    },'''
    'powerOutagePolicy.data.dmeData': {
        'name': 'PowerOutagePolicy',
...
'1.7.5': {
    ...
    'measure': {
        ...
        'endpoint': '/rest/mbdetnrs/1.0/managers/1/actions/restoreSettings',
        'columns': {
            'Periodicity': 'features.measure.data.dmeData.periodicity'
        }
    },
    'mqtt.data.certificateData.trustedClient': {
        'name': 'Mqtt',
